...
def fittingStatistics_v5(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        ...
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.2,40,10],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.2,40,10],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.2,40,10],
