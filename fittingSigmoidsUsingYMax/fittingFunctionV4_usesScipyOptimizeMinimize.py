...
def fittingStatistics_v4(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.6,40,-5],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.6,40,-5],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [-0.4,-0.6,40,-5],
