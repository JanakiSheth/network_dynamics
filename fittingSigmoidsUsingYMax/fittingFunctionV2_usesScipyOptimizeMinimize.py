...
def fittingStatistics_v2(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,-5],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,-5],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,-5],
