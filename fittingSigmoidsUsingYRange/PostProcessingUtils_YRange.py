...
def moveToSigmoid(response_Light,
    ...
    startingValues = [[0.4,-0.8,11,-5],[0.4,-0.8,11,10],[0.4,-1.4,11,-5],[0.4,-1.4,11,10],[-0.4,-0.2,40,-5],[-0.4,-0.2,40,10],
                      [-0.8,1,70,-5],[-0.8,1,70,10],[0.2,0.6,70,-5],[0.2,0.6,70,7.5],[-0.6,1.2,30,-5],[-0.6,1.2,30,7.5],
                      [-0.1,-0.4,40,-5],[-0.1,-0.4,40,7.5],[0,0.5,70,-5],[0,0.5,70,7.5]]    
