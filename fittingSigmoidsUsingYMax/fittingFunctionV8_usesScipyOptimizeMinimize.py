...
def fittingStatistics_v8(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        ...
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [0.2,0.8,70,-5],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [0.2,0.8,70,-5],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [0.2,0.8,70,-5],
