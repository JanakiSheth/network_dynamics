...
def fittingStatistics_v3(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,10],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,10],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [0.4,-1,11,10],
