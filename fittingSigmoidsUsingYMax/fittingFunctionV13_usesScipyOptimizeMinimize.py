...
def fittingStatistics_v13(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        ...
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [-0.1,-0.5,40,7.5],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [-0.1,-0.5,40,7.5],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [-0.1,-0.5,40,7.5],
