...
def fittingStatistics_v11(responses_all, 
                         sem_all,
                         amplitude,
    ...
    for i in range(numSoundResponsiveCells):
        ...
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [-0.6,1.2,30,7.5],
        ...
        fitParamsGaussNoLight = scipy.optimize.minimize(gaussian_fn, [1,53,9.2,0],
                                                args=(response_noLight[:,i],sem_noLight[:,i]),
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [-0.6,1.2,30,7.5],
        ...
        fitParamsGaussMidLight = scipy.optimize.minimize(gaussian_fn, [1,53,9.2,0],
                                                args=(response_midLight[:,i],sem_midLight[:,i]),
                                                    method = 'Powell', bounds = gaussBnds,
                                                    options={'maxiter':30000, 'maxfev':30000,'ftol':0.01, 'disp':0}).x
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [-0.6,1.2,30,7.5],
        ...
        fitParamsGaussHighLight = scipy.optimize.minimize(gaussian_fn, [1,53,9.2,0],
                                                args=(response_highLight[:,i],sem_highLight[:,i]),
                                                    method = 'Powell', bounds = gaussBnds,
                                                    options={'maxiter':30000, 'maxfev':30000,'ftol':0.01, 'disp':0}).x
