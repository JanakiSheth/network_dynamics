...
def fittingStatistics_v7(responses_all, 
    ...
    for i in range(numSoundResponsiveCells):
        ...
        fitParamsSigmoidNoLight = scipy.optimize.minimize(sigmoid_fn, [-0.8,1,70,10],
        ...
        fitParamsSigmoidMidLight = scipy.optimize.minimize(sigmoid_fn, [-0.8,1,70,10],
        ...
        fitParamsSigmoidHighLight = scipy.optimize.minimize(sigmoid_fn, [-0.8,1,70,10],
